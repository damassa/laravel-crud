<div x-cloak {{$attributes}}  x-show="{{ $attributes['trigger'] }} == $el.id"
    ...
    <div class='flex flex-col w-full h-full pt-10 bg-gray-600/50'>
        <div @click.away="idmodal=null" class="flex flex-col justify-center w-1/2 shadow dark:bg-gray-700 h-auto m-1 p-3 bg-white self-center rounded-md">
